...
@php
    $storeRoute = route('guru.reports.store');
@endphp
...
<div class="max-w-3xl">
    <div class="flex items-start justify-between mb-4">
        <div>
            ...
            <p class="text-xs text-slate-500">Laporkan kerusakan fasilitas beserta foto (opsional).</p>
        </div>
        <a href="{{ route('guru.reports.index') }}" class="text-xs text-slate-600 hover:text-slate-900">Kembali</a>
    </div>
