...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold mb-4">Buat Peminjaman</h1>

    <div class="bg-white p-4 rounded shadow">
        <form method="POST" action="{{ route('siswa.booking.store') }}">
            @csrf
            ...
            <div class="flex gap-2">
                ...
                <a href="{{ route('siswa.booking.index') }}" class="px-4 py-2 bg-gray-400 text-white rounded">Batal</a>
            </div>
        </form>
    </div>
</div>
